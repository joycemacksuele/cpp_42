...
/*   Updated: 2022/08/07 17:58:52 by jfreitas      ########   odam.nl         */
/*                                                                            */
/* ************************************************************************** */
...
class AAnimal {//Abstract class
	public:
		AAnimal(void);// Default (no args) constructor
		AAnimal(const AAnimal& src);// Overloaded Copy constructor
		virtual AAnimal& operator=(const AAnimal& rhs);// Copy assignment operator
		/* Good to know:
		...
		virtual void		makeSound() const = 0;// virtual method (pure method)
